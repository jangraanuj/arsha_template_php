...
<body>
  ...
  <main id="main">
   ...
   if(isset($_POST['submit'])){
    ...
    $date =    mysqli_real_escape_string($conn,$_POST['city']);
   
     $sql  = "UPDATE user SET fname = '{$fname}' , email = '{$lname}',username = '{$user}', role = '{$role}' 
              ...
              ?>
                  ...
                  <form  action="<?php // $_SERVER =['PHP_SELF']; ?>" method ="POST">
                      ...
                      <!-- <div class="form-group">
                          ...
                          <input type="date" name="date" class="form-control" value="<?php echo $row['date']; ?>" placeholder="" required>
                      </div> -->
