...
// var existing_loan_input = document.getElementById("existing-loan");
...
function calculateLoanEligibility(netIncome, emi, loanTenure) {
	return Math.round((netIncome - emi) / 2 * 12 * (loanTenure / 2));
}
...
function displayDetails() {
	...
	let netIncomePerMonth = parseFloat(document.getElementById("net-income").value);
