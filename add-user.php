...
if(isset($_POST['btn_save'])){
 ...
 $state = mysqli_real_escape_string($conn, $_POST['state']);
  ...
  if(mysqli_num_rows($result) > 0) {
    ...
    $sql1 = "INSERT INTO user (fname, email, username, password, role, city, state) 
             VALUES ('$fname', '$lname', '$user', '$password', '$role', '$city', '$state')";
              ...
              <div class="col-md-offset-3 col-md-6">
                  ...
                  <form  action="#" name ="add-user-form " id="Myform" method ="POST" autocomplete="off">
                      <div class="form-group">
                          ...
                          <input style="border: 1px solid #ced4da;border-radius: 10px;padding: 12px;width: 100%; font-size: 16px;font-weight: 600; font-family:  Arial, sans-serif;" type="email" name="email" class="form-control" id="inputName5" placeholder="Email" required>
